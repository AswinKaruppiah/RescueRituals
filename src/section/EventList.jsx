  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      {loading && events.length === 0 ? (
        ...
        /* 2. Full Error State */
        <div className="p-12 text-center rounded-2xl bg-neutral-900/60 border border-rose-900/40 space-y-4 max-w-xl mx-auto">
          <div className="w-14 h-14 mx-auto rounded-full bg-rose-950/80 border border-rose-800/80 flex items-center justify-center text-rose-400 shadow-lg">
            <AlertTriangle className="w-7 h-7" />
          </div>
          <div className="space-y-1">
            <h3 className="text-lg font-bold text-white">Unable to Load Events</h3>
        ...
        <div className="p-16 text-center rounded-2xl bg-neutral-900/50 border border-neutral-800 space-y-4 max-w-lg mx-auto">
          <div className="w-16 h-16 mx-auto rounded-full bg-neutral-800 border border-neutral-700 flex items-center justify-center text-neutral-400 shadow-xl">
